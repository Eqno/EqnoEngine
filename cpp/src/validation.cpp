...
Validation::Validation(const bool enabled,
	CStrings layers,
	const MessengerCreateInfo& messengerInfo) : enabled(enabled),
layers(std::move(layers)),
messengerCreateInfo(messengerInfo) {}

VkResult Validation::CreateMessengerEXT(const VkInstance& instance,
...
void Validation::DestroyMessengerEXT(const VkInstance& instance,
